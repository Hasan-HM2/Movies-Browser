...
import Grid from "@mui/material/Grid2"; // استخدام Grid2 كما في كودك الأصلي
...
export default function MovieDetails() {
	...
	// التأكد من حماية الكود باستخدام Optional Chaining أثناء التحقق من المفضلة
		...
		<Box
			sx={{
				...
				backgroundImage: movie?.backdrop_path
					? `linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgb(0, 0, 0) 100%), url(https://image.tmdb.org/t/p/original${movie.backdrop_path})`
					: "none",
